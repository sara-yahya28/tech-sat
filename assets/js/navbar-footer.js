          ...
          '<div class="row gy-5">' +
            ...
            '<div class="col-lg-4">' +
              '<div class="footer-content">' +
                ...
                '</a>' +
                '<p class="mb-4">الموزع الحصري لـ IEC Global Telecom في اليمن. حلول اتصالات فضائية موثوقة للقطاعات الحيوية: الحكومة، الإنساني، البحري، الطاقة، الإعلام، والمؤسسات.</p>' +
            ...
            '<div class="col-lg-2 col-6">' +
              '<div class="footer-links">' +
                '<h4>حلولنا</h4>' +
                '<ul>' +
                  '<li><a href="services.html"><i class="bi bi-chevron-left"></i> حلول VSAT</a></li>' +
                  '<li><a href="services.html"><i class="bi bi-chevron-left"></i> صوت وبيانات</a></li>' +
                  '<li><a href="services.html"><i class="bi bi-chevron-left"></i> تكامل الأنظمة</a></li>' +
                  '<li><a href="services.html"><i class="bi bi-chevron-left"></i> شبكات مُدارة</a></li>' +
                  '<li><a href="services.html"><i class="bi bi-chevron-left"></i> دعم فني 24/7</a></li>' +
                '</ul>' +
              '</div>' +
            '</div>' +
            ...
            '<div class="col-lg-4">' +
              '<div class="footer-contact">' +
                ...
                '<div class="contact-item">' +
                  ...
                  '<div class="contact-info"><p dir="ltr">+967 2 396 056</p></div>' +
                '</div>' +
                '<div class="contact-item">' +
        ...
        '<div class="footer-bottom">' +
          '<div class="container">' +
            '<div class="row align-items-center">' +
              '<div class="col-lg-6">' +
                '<div class="copyright">' +
                  '<p>© <strong class="px-1 sitename">Tech-Sat</strong> جميع الحقوق محفوظة 2026</p>' +
                '</div>' +
              '</div>' +
              '<div class="col-lg-6">' +
